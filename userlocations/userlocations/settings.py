# Django settings for userlocations project.
import os
...
ADMINS = (
    ('kenny rachuonyo', 'krmboya@gmail.com'),
)
...
SECRET_KEY = '*c0y4@a6sw%q*7@v-+#stocn6w83(0)rcadg=f7!-@x&q8t-ve'
...
ROOT_URLCONF = 'userlocations.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'userlocations.wsgi.application'
