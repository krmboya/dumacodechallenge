...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'userslocations_mapping', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['userprofile.Profile'])),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Location'])),
        ))
        db.send_create_signal(u'userslocations', ['Mapping'])


    def backwards(self, orm):
        # Deleting model 'Mapping'
        db.delete_table(u'userslocations_mapping')
    ...
    models = {
        ...
        u'userslocations.mapping': {
            'Meta': {'object_name': 'Mapping'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['locations.Location']"}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['userprofile.Profile']"})
        }
    }

    complete_apps = ['userslocations']